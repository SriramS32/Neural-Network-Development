...
public class ReverseNetDiffAct
{
    ...
    public static final int maxCycles = 1000000;	
    ...
    public static void main(String[] args) throws IOException{
        ...
        Scanner scanIn = new Scanner(new File("/users/Sriram/Desktop/2014-15/Neural Nets/StarterInput.txt"));
    ...
    public void setOut()
    {
        itargetOutput = new double[][] {{0.0, 1.0},{1.0,0.0}}; //Make sure this has new outputs updated
    }
    ...
    public ReverseNetDiffAct(double[][] iWeights1, double[][] hWeights1)
    {
        iWeights=iWeights1;
        hWeights=hWeights1;
        jnodes = new double[cases][Hidden];
    }
    public double randBound (double doublelowerB,double upperB)
    {
